...
BUSINESS_TERMS = ["Inc", "LLC", "Corp", "Ltd", "Corporation", "GmbH", "Group"]
PATTERN = re.compile(r'\b(' + '|'.join(map(re.escape, BUSINESS_TERMS)) + r')\b', re.IGNORECASE)
